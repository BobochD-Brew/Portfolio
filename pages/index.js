      ...
      <main className="h-full w-full flex flex-col">
        ...
        <div id="ScollDiv" style={{
          ...
          <div className='flex justify-start space-x-0 text-[#000613] m-5 items-center' style={{
            ...
            <ProjectCard date="06/2022" text="VRF Contract Use" link="https://polygonscan.com/address/0x9c56c03a64ec4d81f549c900fb235b31b1390fe2#code" image="chainlink.PNG" />
            <ProjectCard date="04/2022" text="Juice Crew Game" link="http://play.juicecrewnft.com" image="juice.gif" />
            <ProjectCard date="03/2022" text="Rooftop Skin" link="https://opensea.io/assets/matic/0x2953399124f0cbb46d2cbacd8a89cf0599974963/105369117006084633903751782557553396941953685787847558065691149620891090944200" image="rooftop.gif" />
            <ProjectCard date="03/2022" text="Backdoors" link="https://opensea.io/collection/boboch?search[query]=Backdoor&search[sortAscending]=true&search[sortBy]=PRICE" image="backdoor.png" />
            <ProjectCard date="03/2022" text="Color Wave" link="https://opensea.io/assets/matic/0x2953399124f0cbb46d2cbacd8a89cf0599974963/105369117006084633903751782557553396941953685787847558065691149626388649082895" image="colorsurf.gif" />
            <ProjectCard date="03/2022" text="NFT Bulksender" link="https://opensea.io/assets/matic/0x2953399124f0cbb46d2cbacd8a89cf0599974963/105369117006084633903751782557553396941953685787847558065691149619791579317224" image="https://lh3.googleusercontent.com/Y_ILLR5E5HbVaq87Kokq1I6_SsW7ahid6yh658gzlDPCK3FfB2jNJjxRWW3rUOMoaqO2Um6C07ki0RMdWXMkPqoJSd11nHwyCjrdkA=w600" />
            <ProjectCard date="02/2022" text="Surfboards" link="https://opensea.io/collection/podmarket?search[sortBy]=PRICE&search[sortAscending]=true&search[query]=surf" image="surf.gif" />
            <ProjectCard date="02/2022" text="Pod Market @HQ" maxSize="30" link="https://opensea.io/collection/podmarket" image="podmarket.gif" />
          ...
          <div className='flex justify-start space-x-0 text-[#000613] m-5 items-center' style={{
            ...
            <SkillCard text="P5.js" link="https://p5js.org"/>
            ...
            <SkillCard text="HTML/CSS" link="https://www.w3.org/standards/webdesign/htmlcss"/>
            ...
            <SkillCard text="C4d" link="https://www.blender.org"/>
            ...
            <SkillCard text="Game Maker" link="https://gamemaker.io/en/blog/gamemaker-studio-1-dot-4-9999-released"/>
            <SkillCard text="GDevelop" link="https://gdevelop.io"/>
            <SkillCard text="Rpg Maker" link="https://www.rpgmakerweb.com/products/rpg-maker-2003"/>
